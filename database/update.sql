...
INSERT INTO `admin` VALUES (1,'admin','admin@smkn40-jkt.sch.id','admin123','Administrator','uploads/admin/admin_1_1741506108.jpg','2026-03-27 20:07:58','2025-03-03 08:23:13','2026-03-27 13:07:58');
...
LOCK TABLES `kepsek` WRITE;
/*!40000 ALTER TABLE `kepsek` DISABLE KEYS */;
INSERT INTO `kepsek` VALUES (1,'kepsek','kepsek@sekolah.sch.id','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','Kepala Sekolah','196501011990031001',NULL,'2026-03-16 08:54:16','2026-03-11 00:23:03','2026-03-16 08:54:16');
/*!40000 ALTER TABLE `kepsek` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `wali_kelas` (
  ...
  `nama_lengkap` varchar(100) NOT NULL,
  `nip` varchar(30) DEFAULT NULL,
  `kelas` varchar(20) NOT NULL COMMENT 'Contoh: X-A, XI-IPA-1, XII-IPS-2',
...
INSERT INTO `wali_kelas` VALUES (1,'Supri','wk.xa@sekolah.sch.id','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','Wali Kelas X TKR 1','197001011995032001','TKR','10','TKR 1','TKR',NULL,NULL,'2026-03-11 00:17:56','2026-03-16 08:07:59'),(2,'Gading','wk.xb@sekolah.sch.id','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','Wali Kelas X TKJ 1','197002021995032002','TKJ','10','TKJ 1','TKJ',NULL,NULL,'2026-03-11 00:17:56','2026-03-16 08:07:59'),(3,'Emma','wk.xi@sekolah.sch.id','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','Wali Kelas X MP 1','197503031998031003','MP','10','MP 1','MP',NULL,NULL,'2026-03-11 00:17:56','2026-03-16 08:07:59'),(4,'Indrawan','wk.xii@sekolah.sch.id','password','Wali Kelas X TSM 1','197804042000042004','TSM','10','TSM 1','TSM',NULL,'2026-03-16 08:32:11','2026-03-11 00:17:56','2026-03-16 08:32:11');
...
-- Dump completed on 2026-03-27 20:16:21
