...
<head>
    ...
    <title>Profil Siswa - SMK NURUL ULUM</title>
...
<body class="min-h-screen text-gray-800 bg-fixed">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 glass-effect border-r border-violet-200 z-50 sidebar-transition -translate-x-full lg:translate-x-0">
        ...
        <nav class="p-4 space-y-2 overflow-y-auto no-scrollbar" style="max-height: calc(100vh - 150px);">
            ...
            <a href="../riwayat/" class="flex items-center gap-3 text-gray-600 p-3 rounded-lg hover:bg-violet-100 transition-colors">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <div class="glass-effect rounded-xl overflow-hidden">
                        ...
                        <div class="p-4 sm:p-6 text-center">
                            <h2 class="text-lg sm:text-xl font-bold text-gray-800 mb-1"><?= htmlspecialchars($siswa['nama_lengkap']) ?></h2>
                            ...
                            <div class="space-y-3 mt-4">
                                <div class="flex items-center justify-center text-gray-700">
                                    <i class="fas fa-id-card text-violet-500 mr-2"></i>
                                ...
                                <div class="flex items-center justify-center text-gray-700">
                                    <i class="fas fa-graduation-cap text-violet-500 mr-2"></i>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="mobile-form-spacing">
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama_lengkap" name="nama_lengkap"
                                    ...
                                    class="w-full px-3 lg:px-4 py-2.5 rounded-lg bg-gray-50/50 border border-gray-300 text-gray-800 focus:outline-none focus:border-violet-500 mobile-touch-target">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nis" value="<?= htmlspecialchars($siswa['nis']) ?>" disabled
                                    class="w-full bg-gray-50/30 border border-gray-300 rounded-lg px-3 py-2.5 text-gray-500 cursor-not-allowed mobile-touch-target">
                                <p class="text-xs text-gray-500 mt-1">NIS tidak dapat diubah</p>
                            </div>

                            <div class="mb-4">
                                <label for="kelas" class="block text-sm text-gray-500 mb-2">Kelas & Jurusan</label>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" name="update_profile"
                                    class="px-6 py-2.5 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium text-gray-800 
                        ...
                        <form method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 password-grid mobile-form-spacing">
                            ...
                            <div class="md:col-span-3 flex justify-end mt-2">
                                <button type="submit" name="change_password"
                                    class="px-6 py-2.5 bg-yellow-600 hover:bg-yellow-700 rounded-lg font-medium text-gray-800 
