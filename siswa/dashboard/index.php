        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-6xl mx-auto">
                ...
                <?php if ($submission_message): ?>
                    <div
                        class="mb-6 p-4 rounded-lg border <?= $submission_status === 'success' ? 'bg-green-500/10 border-green-500/30 text-green-500' : 'bg-red-500/10 border-red-500/30 text-red-500' ?>">
                        <div class="flex items-center">
                            <i
                                class="fas <?= $submission_status === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle' ?> mr-3"></i>
                            ...
                            <div class="p-3 lg:p-4 border border-red-200 rounded-lg bg-red-500/10 mb-4">
                                <div class="flex items-center text-red-500">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs mt-1">Silakan ajukan ulang absensi Anda dengan informasi yang
                                            benar</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="camera-container"
                                    ...
                                    <div class="relative mb-3 rounded-lg overflow-hidden bg-black">
                                        <video id="camera-preview"
                                            class="w-full h-40 sm:h-48 md:h-56 lg:h-64 object-cover rounded-lg"></video>
                                        <canvas id="camera-canvas" class="hidden"></canvas>
                                        <div id="camera-overlay"
                                            class="hidden absolute inset-0 bg-black flex items-center justify-center">
                                            <img id="camera-result" class="max-h-full max-w-full rounded-lg" src=""
                                                alt="Captured photo">
                                        </div>
                        ...
                        <?php else: ?>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div id="camera-container"
                                    ...
                                    <div class="relative mb-3 rounded-lg overflow-hidden bg-black">
                                        <video id="camera-preview"
                                            class="w-full h-48 lg:h-64 object-cover rounded-lg"></video>
                                        <canvas id="camera-canvas" class="hidden"></canvas>
                                        <div id="camera-overlay"
                                            class="hidden absolute inset-0 bg-black flex items-center justify-center">
                                            <img id="camera-result" class="max-h-full rounded-lg" src=""
                                                alt="Captured photo">
                                        </div>
                                    ...
                                    <div class="p-3 lg:p-4 hover:bg-gray-50/30 transition-colors">
                                        <div
                                            ...
                                            <div>
                                                ...
                                                ?>">
                                                    <i
                                                        class="fas <?= $request['status'] === 'Sakit' ? 'fa-hospital' : 'fa-clipboard-list' ?> mr-1"></i>
                                                    <?= $request['status'] ?>
                                                </span>
                                        ...
                                        <div class="mt-3 flex items-center justify-between flex-wrap gap-2">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-500/10 text-yellow-500 border border-yellow-500/30">
                                            ...
                                            <button type="button" onclick="showConfirmationModal(<?= $request['id'] ?>)"
                                                class="text-red-400 hover:text-red-300 transition-colors text-sm flex items-center">
