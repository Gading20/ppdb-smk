        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center mb-6">
                    <a href="konseling.php" class="mr-4 p-2 rounded-full hover:bg-gray-800 transition-colors">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold">Tambah Konseling</h1>
                        <p class="text-gray-400 text-sm">Pilih siswa dan isi detail sesi konseling</p>
                    </div>
                </div>
                ...
                <form method="POST" id="mainForm">
                    ...
                    <div class="glass-effect rounded-xl p-4 md:p-6 mb-4 animate-fade-in">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm text-gray-400 mb-1.5">Nama Siswa <span class="text-red-400">*</span></label>
                        ...
                        <!-- Riwayat konseling siswa -->
                        <div id="riwayat-box" class="hidden mt-4 p-3 rounded-lg bg-gray-800/60 border border-gray-700">
                            <p class="text-xs text-gray-400 mb-2 font-medium">
                                <i class="fas fa-history mr-1 text-purple-400"></i>Riwayat konseling siswa ini:
                            </p>
                    ...
                    <div class="glass-effect rounded-xl p-4 md:p-6 mb-4 animate-fade-in">
                        ...
                        <div id="jenis-preview" class="hidden mt-4 p-3 rounded-lg bg-purple-900/20 border border-purple-500/40">
                            <p class="text-xs text-purple-400 mb-1 font-medium">Jenis dipilih:</p>
                    ...
                    <div class="glass-effect rounded-xl p-4 md:p-6 mb-4 animate-fade-in">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <!-- Konselor -->
                            <div>
                                <label class="block text-sm text-gray-400 mb-1.5">Nama Konselor <span class="text-red-400">*</span></label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="masalah" id="masalah" rows="3" required
                                ...
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-2.5 text-white focus:outline-none focus:border-purple-500 resize-none"></textarea>
                    ...
                    detail.innerHTML = data.slice(0, 5).map(d => `
                        <div class="riwayat-item rounded-lg p-2.5 flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs text-white truncate">${d.masalah}</p>
                                <p class="text-xs text-gray-500">${d.tanggal} · ${d.konselor}</p>
                            </div>
                            <span class="text-xs flex-shrink-0 ${statusColor[d.status] || 'text-gray-400'}">${d.status}</span>
                        </div>`).join('');
                    if (data.length > 5) {
