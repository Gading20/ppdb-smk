...
<body class="min-h-screen text-gray-800 bg-fixed">
        ...
        <nav class="p-4 space-y-2 overflow-y-auto no-scrollbar" style="max-height: calc(100vh - 76px);">
            ...
            <li class="relative group">
                ...
                <ul class="ml-8 mt-2 block">
                    ...
                    <li><a href="index.php" class="block p-2 text-violet-500 bg-purple-500/10 rounded-lg">Pelanggaran</a></li>
                    <li><a href="konseling.php" class="block p-2 text-gray-600 hover:text-violet-600 hover:bg-violet-100 rounded-lg">Konseling</a></li>
                </ul>
            </li>
        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center mb-6">
                    <a href="../laporan/laporan_pelanggaran.php" class="mr-3 p-2 rounded-full hover:bg-gray-100 transition-colors">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold">Detail Pelanggaran</h1>
                        <p class="text-sm md:text-base text-gray-500">Informasi lengkap pelanggaran siswa</p>
                    </div>
                </div>
                ...
                <?php if (isset($error)): ?>
                    <div class="bg-red-500/10 border border-red-200 rounded-lg p-4 mb-6 flex items-center animate-fade-in">
                    ...
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-6">
                        <div class="relative">
                            <img src="../../<?= htmlspecialchars($pelanggaran['foto_profil'] ?: 'assets/default/avatar.png') ?>"
                                ...
                                class="w-20 h-20 md:w-24 md:h-24 rounded-xl object-cover border border-violet-200">
                            <!-- Jenis indicator badge -->
                            <div class="absolute -bottom-2 -right-2 px-2 py-0.5 rounded-full text-xs font-bold
                                <?= $pelanggaran['jenis_pelanggaran'] === 'Berat' ? 'bg-red-500/80 text-gray-800' : ($pelanggaran['jenis_pelanggaran'] === 'Sedang' ? 'bg-yellow-500/80 text-gray-900' : 'bg-green-500/80 text-gray-800') ?>">
                ...
                <div class="glass-effect rounded-xl p-4 md:p-6 mb-6 animate-fade-in">
                    ...
                    <div class="flex flex-wrap gap-2 mb-5">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs md:text-sm
                            <?= $pelanggaran['jenis_pelanggaran'] === 'Berat' ? 'bg-red-50 text-red-500 border border-red-200' : ($pelanggaran['jenis_pelanggaran'] === 'Sedang' ? 'bg-yellow-50 text-yellow-600 border border-yellow-500/30' : 'bg-green-50 text-green-600 border border-green-500/30') ?>">
                        ...
                        <!-- Status badge -->
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs md:text-sm
                            <?= $pelanggaran['status'] === 'Selesai' ? 'bg-green-50 text-green-600 border border-green-500/30' : ($pelanggaran['status'] === 'Proses' ? 'bg-amber-500/10 text-amber-400 border border-amber-500/30' : 'bg-gray-500/10 text-gray-500 border border-gray-500/30') ?>">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs md:text-sm font-bold
                            <?= $pelanggaran['jenis_pelanggaran'] === 'Berat' ? 'bg-red-50 text-red-500 border border-red-200 poin-berat' : ($pelanggaran['jenis_pelanggaran'] === 'Sedang' ? 'bg-yellow-50 text-yellow-600 border border-yellow-500/30' : 'bg-green-50 text-green-600 border border-green-500/30') ?>">
                    ...
                    <!-- Deskripsi -->
                    <div class="mb-4">
                        <p class="text-gray-500 text-xs mb-1">Deskripsi Pelanggaran</p>
                        <div class="bg-gray-50/50 rounded-lg p-3 min-h-[60px]">
                    ...
                    <!-- Tindakan -->
                    <div>
                        <p class="text-gray-500 text-xs mb-1">Tindakan / Sanksi</p>
                        <div class="bg-gray-50/50 rounded-lg p-3 min-h-[60px]">
                            <p class="text-sm">
                ...
                <?php if ($pelanggaran['status'] !== 'Selesai'): ?>
                    <div class="glass-effect rounded-xl p-4 md:p-6 mb-6 animate-fade-in border border-amber-500/20">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block text-xs text-gray-500 mb-1">Tindakan / Sanksi</label>
                                <textarea name="tindakan" rows="2"
                                    placeholder="Isi tindakan yang diberikan..."
                                    class="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-violet-500"><?= htmlspecialchars($pelanggaran['tindakan'] ?? '') ?></textarea>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-between animate-fade-in">
                    ...
                    <a href="pelanggaran.php" class="hidden lg:flex px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm items-center gap-2 transition-colors">
    ...
    <div id="deleteModal" class="fixed inset-0 flex items-center justify-center z-[100] hidden">
        ...
        <div class="glass-effect rounded-lg p-6 w-11/12 max-w-md relative z-10 mx-4 animate-fade-in">
            ...
            <p class="text-gray-700 mb-6">Apakah Anda yakin ingin menghapus data pelanggaran ini? Tindakan ini tidak dapat dibatalkan.</p>
