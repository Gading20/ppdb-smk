            ...
            <div class="max-w-7xl mx-auto">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <select name="jurusan"
                                                ...
                                                <option value="DKV" <?= $jurusan === 'DKV' ? 'selected' : '' ?>>DKV
                                                </option>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="glass-effect rounded-xl p-4 sm:p-6">
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex justify-between items-center p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($total_absensi > 0): ?>
                                        <span
                                            class="text-xs text-gray-400 block"><?= round(($status_counts['Hadir'] / $total_absensi) * 100, 1) ?>%</span>
                                    <?php endif; ?>
                                </div>
                            </div>

                            <div
                                class="flex justify-between items-center p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                                <div class="flex items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($total_absensi > 0): ?>
                                        <span
                                            class="text-xs text-gray-400 block"><?= round(($status_counts['Sakit'] / $total_absensi) * 100, 1) ?>%</span>
                                    <?php endif; ?>
                                </div>
                            </div>

                            <div
                                class="flex justify-between items-center p-3 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                                <div class="flex items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($total_absensi > 0): ?>
                                        <span
                                            class="text-xs text-gray-400 block"><?= round(($status_counts['Izin'] / $total_absensi) * 100, 1) ?>%</span>
                                    <?php endif; ?>
                                </div>
                            </div>

                            <div
                                class="flex justify-between items-center p-3 bg-orange-500/10 border border-orange-500/30 rounded-lg">
                                <div class="flex items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($total_absensi > 0): ?>
                                        <span
                                            class="text-xs text-gray-400 block"><?= round(($status_counts['Terlambat'] / $total_absensi) * 100, 1) ?>%</span>
                                    <?php endif; ?>
                                </div>
                            </div>

                            <div
                                class="flex justify-between items-center p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                                <div class="flex items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <?php if ($total_absensi > 0): ?>
                                        <span
                                            class="text-xs text-gray-400 block"><?= round(($status_counts['Alpha'] / $total_absensi) * 100, 1) ?>%</span>
                                    <?php endif; ?>
                                </div>
                            </div>
