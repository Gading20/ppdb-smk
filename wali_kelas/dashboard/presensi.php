                ...
                <div class="glass rounded-xl p-5 mb-6 fade-up" style="animation-delay:.1s">
                    ...
                    <form method="GET" id="filterForm">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <!-- Status -->
                            <div>
                                <label class="text-xs text-gray-400 mb-1 block">Status Kehadiran</label>
                            ...
                            <div>
                                ...
                                <select name="approval" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-500">
                                ...
                                <tbody class="divide-y divide-gray-800/40">
                                    ...
                                    ?>
                                        <tr class="hover:bg-emerald-900/10 transition-colors">
                                            ...
                                            <td class="px-5 py-3 text-gray-400 max-w-[160px] truncate">
