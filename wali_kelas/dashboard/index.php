            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="glass rounded-xl overflow-hidden fade-up" style="animation-delay:.2s">
                        <div class="bg-gradient-to-r from-emerald-900/30 to-teal-900/20 px-5 py-4 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="glass rounded-xl overflow-hidden fade-up" style="animation-delay:.22s">
                        <div class="bg-gradient-to-r from-red-900/30 to-orange-900/20 px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                            <h3 class="font-semibold flex items-center gap-2 text-sm">
                    ...
                    <div class="glass rounded-xl overflow-hidden fade-up" style="animation-delay:.25s">
                        <div class="bg-gradient-to-r from-blue-900/30 to-purple-900/20 px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                            <h3 class="font-semibold flex items-center gap-2 text-sm">
