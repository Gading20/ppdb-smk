        ...
        <div class="p-5 md:p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <header class="flex flex-wrap justify-between items-center mb-8 fade-up">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">
                            ...
                            Data pelanggaran siswa – hanya lihat
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <?php
                    $statCards = [
                        ['Ringan (Hari Ini)', $jenis_counts['Ringan'], 'green',  'fa-exclamation-circle', 0],
                        ['Sedang (Hari Ini)', $jenis_counts['Sedang'], 'yellow', 'fa-exclamation-triangle', 0.06],
                        ['Berat (Hari Ini)',  $jenis_counts['Berat'],  'red',    'fa-times-circle', 0.12],
                        ['Sedang Diproses',   $proses_count,           'amber',  'fa-hourglass-half', 0.18],
                    ];
                    foreach ($statCards as [$lbl, $val, $col, $ico, $delay]): ?>
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 fade-up" style="animation-delay:.15s">
                    ...
                    <!-- Table header bar -->
                    <div class="bg-gradient-to-r from-red-50 to-orange-50 px-5 py-4 border-b border-gray-200 flex flex-wrap justify-between items-center gap-3">
                        <h3 class="font-semibold text-gray-800 flex items-center gap-2 text-sm">
                            ...
                            <table class="w-full whitespace-nowrap text-sm">
                                <thead>
                                    <tr class="bg-gray-50 text-gray-500 text-xs uppercase border-b border-gray-200">
                                        ...
                                        <th class="px-4 py-3 text-left">
                                            <a href="<?= buildSortUrl('jenis_pelanggaran') ?>" class="flex items-center gap-1 hover:text-teal-600 transition-colors">
                                                Jenis <?= sortIcon('jenis_pelanggaran', $sort_col, $sort_order) ?>
                                            </a>
                                        </th>
                                        <th class="px-4 py-3 text-left">Deskripsi</th>
                                        <th class="px-4 py-3 text-left">
                                            <a href="<?= buildSortUrl('poin') ?>" class="flex items-center gap-1 hover:text-teal-600 transition-colors">
                                                Poin <?= sortIcon('poin', $sort_col, $sort_order) ?>
                                            </a>
                                        </th>
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    ?>
                                        <tr class="hover:bg-teal-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3">
                                                <span class="text-gray-600 max-w-[150px] truncate block"
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex flex-col gap-1.5">
                                                    <span class="font-bold <?= $p['jenis_pelanggaran'] === 'Berat' ? 'text-red-500' : ($p['jenis_pelanggaran'] === 'Sedang' ? 'text-amber-600' : 'text-green-600') ?>">
                                                        <?= $p['poin'] ?> <span class="font-normal text-xs text-gray-400">poin</span>
                                                    </span>
                                                    <div class="flex flex-wrap gap-1">
                                                        <?php if ($pb > 0): ?>
                                                            <span class="poin-badge j-berat" title="Total poin Berat">
                                                                <i class="fas fa-circle" style="font-size:4px"></i> B:<?= $pb ?>
                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if ($ps > 0): ?>
                                                            <span class="poin-badge j-sedang" title="Total poin Sedang">
                                                                <i class="fas fa-circle" style="font-size:4px"></i> S:<?= $ps ?>
                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if ($pr > 0): ?>
                                                            <span class="poin-badge j-ringan" title="Total poin Ringan">
                                                                <i class="fas fa-circle" style="font-size:4px"></i> R:<?= $pr ?>
                                                            </span>
                                                        <?php endif; ?>
                                            ...
                                            <td class="px-4 py-3 text-gray-500 max-w-[140px] truncate text-sm"
                    ...
                    <?php else: ?>
                        <div class="py-16 text-center text-gray-500">
                            <i class="fas fa-shield-alt text-4xl mb-4 block text-gray-300"></i>
                            <p class="text-gray-600 font-medium">
                                Tidak ada data pelanggaran kelas <?= htmlspecialchars($kelas . ' ' . $jurusan) ?> yang ditemukan
                            </p>
