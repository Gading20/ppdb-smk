                            ...
                            <table class="w-full whitespace-nowrap text-sm">
                                <thead>
                                    <tr class="bg-gray-50/50 text-gray-500 text-xs uppercase">
                                        ...
                                        <th class="px-5 py-3 text-left"><a href="<?= buildSortUrl('jenis_konseling') ?>" class="flex items-center gap-1 hover:text-gray-800">Jenis <?= sortIcon('jenis_konseling', $sort_col, $sort_order) ?></a></th>
                                        <th class="px-5 py-3 text-left">Masalah</th>
                                        <th class="px-5 py-3 text-left"><a href="<?= buildSortUrl('konselor') ?>" class="flex items-center gap-1 hover:text-gray-800">Konselor <?= sortIcon('konselor', $sort_col, $sort_order) ?></a></th>
